...
const RegisterPage: React.FC = () => {
    ...
    const [arePasswordsConsistent, setArePasswordsConsistent] =
        useState(true);
    const [isEmailValidOrEmpty, setIsEmailValidOrEmpty] =
        useState(true);
    const [emailIconState, setEmailIconState] =
        useState<AlertIconState>('hidden');
    const [passwordIconState, setPasswordIconState] =
        useState<AlertIconState>('hidden');
    const [emailIconTooltip, setEmailIconTooltip] =
        useState('Correct email address should be entered');
    const [passwordIconTooltip, setPasswordIconTooltip] =
        useState('The same password should be entered twice');
    ...
    useEffect(() => {
        setArePasswordsConsistent(password === repeatedPassword || password === '' || repeatedPassword === '');
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (arePasswordsConsistent && isEmailValidOrEmpty && email !== '') {
            ...
            if (!arePasswordsConsistent || password === '' || repeatedPassword === '') {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <form id="register-form" onSubmit={handleSubmit} className="flex flex-col" noValidate>
